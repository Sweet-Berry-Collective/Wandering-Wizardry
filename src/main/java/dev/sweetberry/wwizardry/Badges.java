...
public class Badges {
	...
	private static final Text DEV = Text.literal("D").setStyle(STYLE_DEV);
	private static final Style STYLE_ARTIST = FONT.withHoverEvent(translated("wwizardry.badge.artist"));
	private static final Text ARTIST = Text.literal("A").setStyle(STYLE_ARTIST);
	private static final Style STYLE_CONTRIBUTOR = FONT.withHoverEvent(translated("wwizardry.badge.contributor"));
	private static final Text CONTRIBUTOR = Text.literal("C").setStyle(STYLE_CONTRIBUTOR);
