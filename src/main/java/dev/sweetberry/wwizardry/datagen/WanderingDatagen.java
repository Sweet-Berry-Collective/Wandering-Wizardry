...
public class WanderingDatagen {
	...
	public static final WoodType MYCHA_WOOD = registerDataGenerator("mycha_wood", new WoodType("mycha", MapColor.PURPLE, MapColor.LAPIS_BLUE, BlockSoundGroup.NETHER_WOOD, Blocks.STONE));
